...
1. Do the first 20 exercises of [Free Code Camp Javascript Basics](https://learn.freecodecamp.org/javascript-algorithms-and-data-structures/basic-javascript/), up to **Declare String Variable** (don't worry if you do more, we will be assigning that later anyway! :smile:)
